...
nba_2016 <- read.csv("rawdata/csv/NBA_PBP_2015-16.csv")
nba_2017 <- read.csv("rawdata/csv/NBA_PBP_2016-17.csv")
nba_2018 <- read.csv("rawdata/csv/NBA_PBP_2017-18.csv")
nba_2019 <- read.csv("rawdata/csv/NBA_PBP_2018-19.csv")
nba_2020 <- read.csv("rawdata/csv/NBA_PBP_2019-20.csv")
nba_2021 <- read.csv("rawdata/csv/NBA_PBP_2020-21.csv")
```
